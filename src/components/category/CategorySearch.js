...
const rows = [
  { id: 'name', numeric: false, disablePadding: false, label: 'Category' },
  ...
  render() {
    ...
    return (
      <Paper className={classes.root}>
                    ...
                    >
                     <TableCell component="th" scope="row" padding="default">
                      ...
                      <TableCell align="left">
                        <Button variant="outlined" size="medium" color="primary" className={classes.button} component={Link} to="/categories/edit/1">
        ...
        />
       <CommonButton name="Create" color="primary" action="Create"/>
      </Paper>
    );
  }
}
...
const withConnectEnhancedTable = connect(mapStateToProps, mapDispachToProps)(styledComponent)

export default withConnectEnhancedTable;
